...
from formulas.ontario_building_code import specifiedsnowload_part9, basicsnowloadrooffactor_part9, specifiedsnowload_part9_notes
...
def calculations ():
    Cb.value = basicsnowloadrooffactor_part9(w.value)
    ...
    S.value = specifiedsnowload_part9(Cb.value, Ss.value, Sr.value)

calc.CalcStyles(title_dictionary, inputs_list, output_list, main_output, calculations, specifiedsnowload_part9_notes).add_calc_style1()
