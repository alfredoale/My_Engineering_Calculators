...
from .ontario_building_code_2024.version_2025_01.part_9.sb1_climatic_and_seismic_data.wind_velocity_pressure_calculator import wind_velocity_pressure_calculator
...
CALCULATORS = {
    ...
    **data_table_calculators,
    ...
    wind_velocity_pressure_calculator.title: wind_velocity_pressure_calculator,
}